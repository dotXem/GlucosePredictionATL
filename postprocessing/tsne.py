...
class T_SNE(object):
    ...
    def save(self, pca_components, tsne_components, split_source=0, split_target=None):
        features, y = self.compute_tsne_features(pca_components, tsne_components, split_source=split_source, split_target=split_target)
    ...
    def compute_perplexity(self, n_neighbours, pca_components, tsne_components, tsne_perplexity=30, learning_rate=200.0,
        ...
        printd("start perplexity computation")
        ...
        printd("neighbours classes distribution computed")
