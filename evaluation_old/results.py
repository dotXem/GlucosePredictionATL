from postprocessing.metrics.subject_classifier_metrics import precision, recall, f1
from tools.compute_subjects_list import compute_subjects_list
import pathlib
import os
from evaluation_old.rmse import RMSE
from postprocessing.metrics.drmse import dRMSE
from evaluation_old.cg_ega.cg_ega import CG_EGA
import numpy as np
import openpyxl
from evaluation_old.r import r
from evaluation_old.fit import fit
from evaluation_old.time_lag import time_lag
from evaluation_old.mape import MAPE
import pickle
import _misc
import pandas as pd
...
class ResultsTargetAnalyzer():
    ...
    def __init__(self, source_dataset, target_dataset, model_name, exp_name, freq=_misc.freq):
...
class ResultsTarget():
    ...
    def __init__(self, exp_name, source_dataset, target_dataset, target_subject, model_name, freq=_misc.freq,
        ...
        if results is not None:
            ...
            if file == "auto":
                file = os.path.join(_misc.path, "results", source_dataset + "_2_" + target_dataset,
    ...
    def to_excel(self, params, file_name="results.xlsx"):
        """
            ...
            :return:
        """
        file = os.path.join(_misc.path, "results", file_name)
    ...
    def save(self):
        """
            ...
            :return: /
        """
        dir = os.path.join(_misc.path, "results", self.source_dataset + "_2_" + self.target_dataset,
