...
class T_SNE(object):
    ...
    def save(self, pca_components, tsne_components, split_source=0, split_target=None):
        ...
        dir = os.path.join(_misc.path, "results", self.source_dataset + "_2_" + self.target_dataset, "TSNE",
                           self.exp_name)
    ...
    def compute_tsne_features(self, pca_components, tsne_components, perplexity=30, learning_rate=200.0, split_source=0,
        ...
        pca_features = PCA(pca_components, random_state=_misc.seed).fit_transform(features)
        tsne_features = TSNE(tsne_components, perplexity=perplexity, learning_rate=learning_rate,
                             random_state=_misc.seed).fit_transform(pca_features)
    ...
    def compute_perplexity2(self, n_neighbours, pca_components, tsne_components, tsne_perplexity=30, learning_rate=200.0,
                           split_source=0, split_target=None, use_tsne=True):
